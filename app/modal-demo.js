            ...
            <LiquidGlassButton
              ...
              onPress={() =>
                showAlert({
                  ...
                  message:
                    'This is a longer message to demonstrate how the glass modal handles text content that spans multiple lines. The modal should gracefully expand to accommodate the content while maintaining its beautiful liquid glass appearance.',
                })
              }
            />
            ...
            <LiquidGlassButton
              ...
              onPress={() =>
                showModal({
                  ...
                  message:
                    'This modal cannot be closed by tapping outside. You must choose an option.',
