...
const FaceOverlayMask = ({ 
  ...
  useEffect(() => {
    if (isCapturing) {
      ...
      const backgroundOpacityAnimation = Animated.timing(backgroundOpacity, {
...
const styles = StyleSheet.create({
  circleIndicator: {
    position: 'absolute',
    borderWidth: 2,
    borderColor: 'rgba(255, 255, 255, 0.5)', // Более видимая белая рамка
...
export default FaceOverlayMask;